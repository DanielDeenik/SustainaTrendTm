...
try:
    # Try importing the MongoDB service
    try:
        from frontend.services.mongodb_service import MongoDBService, get_database, verify_connection, close_connections
        logger.info("MongoDB service imported from frontend package")
    except ImportError:
        # Fallback to direct import
        from mongodb_service import MongoDBService, get_database, verify_connection, close_connections
        logger.info("MongoDB service imported directly")
